/**************************************************************************************
 *   WindowHelper.h  --  This file is part of Character Practice Mod.                 *
 *                                                                                    *
...
class WindowHelper {
	public:
		static bool FindSA2Window();
		static void FatalError(LPCWSTR, LPCWSTR);

	private:
		static inline HWND SA2Window = NULL;
		static BOOL CALLBACK EnumWindowCallback(HWND, LPARAM);
		static bool IsMainWindow(HWND);
};